...
public final class ActivityMainBinding implements ViewBinding {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.cattlediag;
      TextView cattlediag = ViewBindings.findChildViewById(rootView, id);
      if (cattlediag == null) {
        break missingId;
      }

      return new ActivityMainBinding((ConstraintLayout) rootView, btnMain, cattlediag);
    }
